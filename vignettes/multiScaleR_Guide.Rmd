...
library(multiScaleR)
load(system.file("extdata", "vignette_data1.RData", package = 'multiScaleR'))
load(system.file("extdata", "vignette_data2.RData", package = 'multiScaleR'))
load(system.file("extdata", "vignette_data3.RData", package = 'multiScaleR'))
load(system.file("extdata", "vignette_data4.RData", package = 'multiScaleR'))
load(system.file("extdata", "vignette_data5.RData", package = 'multiScaleR'))
load(system.file("extdata", "vignette_data6.RData", package = 'multiScaleR'))
load(system.file("extdata", "vignette_data7.RData", package = 'multiScaleR'))
load(system.file("extdata", "vignette_data8.RData", package = 'multiScaleR'))
load(system.file("extdata", "vignette_data9.RData", package = 'multiScaleR'))
load(system.file("extdata", "vignette_data10.RData", package = 'multiScaleR'))
load(system.file("extdata", "vignette_data11.RData", package = 'multiScaleR'))
load(system.file("extdata", "opt_occ.RData", package = 'multiScaleR'))
```
