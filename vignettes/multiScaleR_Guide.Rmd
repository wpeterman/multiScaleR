...
- **σ (sigma)**: The scale parameter of the kernel function (in map units, e.g., meters). A σ of 300 m with a Gaussian kernel means that landscape cells roughly 493 m away contribute 10% of the weight of the focal cell.
